...
public:
  HeightMapSpoofNode() : Node("height_mapping_spoof_node"),
    ...
    ransac_radius_ = declare_parameter<double>("ransac_radius", 0.5);
    ransac_z_   = declare_parameter<double>("ransac_z", -0.25);
...
private:
  ...
  double ransac_radius_{0.5};
  double ransac_z_{-0.25};
